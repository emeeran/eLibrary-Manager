...
|----|------|--------|---------|-------------|-----------|
| 001 | [Library Management](001-library-management.md) | Active | 1.1.0 | 2026-09-20 | `app/routes/library.py`, `app/services/library_service.py` |
...
| 004 | [Bookmarks](004-bookmarks.md) | Active | 1.1.1 | 2026-09-20 | `app/models.py` (Bookmark), `app/routes/reader.py` |
| 005 | [Notes & Annotations](005-notes-annotations.md) | Active | 1.1.0 | 2026-04-15 | `app/models.py` (Note, Annotation), `app/routes/reader.py` |
| 006 | [Text-to-Speech](006-text-to-speech.md) | Active | 1.1.0 | 2026-09-21 | `app/routes/ai_tts.py`, `app/static/js/tts.js` |
| 007 | [Settings](007-settings.md) | Active | 1.0.0 | 2026-04-15 | `app/routes/settings.py` |
| 008 | [File Parsers](008-file-parsers.md) | Active | 1.1.0 | 2026-09-20 | `app/parsers/`, `app/scanner.py` |
| 009 | [NAS Integration](009-nas-integration.md) | Active | 1.0.1 | 2026-09-20 | `app/storage/`, `app/nas_health.py`, `app/nas_cache.py` |
...
001-library-management ──► 010-hidden-books
001-library-management ──► 011-calibre-integration ──► 013-calibre-reader-deeplink
001-library-management ──► 012-full-text-search

014-default-file-viewer ◄── 001, 002, 007, 013

007-settings (standalone; declares a dependency on 003 for AI provider settings — affects all above via configuration)
```
