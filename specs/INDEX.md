...
| 011 | [Calibre Integration](011-calibre-integration.md) | Active | 1.2.0 | 2026-06-30 | `app/services/calibre_sync_service.py`, `app/services/calibre_sync_monitor.py`, `app/routes/calibre.py` |
